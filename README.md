...
- `cryptnox/tools/cryptnox-cli`: The Cryptnox Command Line Interface (CLI) tool.

## Installation

To use this tap, first add it to your Homebrew setup:

```bash
brew tap cryptnox/tools
```

Then, install the `cryptnox-cli` formula:
